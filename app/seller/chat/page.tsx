...
export default async function SellerChatPage({ searchParams }: PageProps) {
  ...
  if (partnerId) {
    ...
    redirect(`/seller/chat?partnerId=${firstPartner.partnerId}${firstPartner.productId ? `&productId=${firstPartner.productId}` : ""}`);
  }
